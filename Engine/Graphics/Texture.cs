...
namespace Engine.Graphics
{
    ...
    public class AnimatedTexture
    {
        ...
        public AnimatedTexture(Frame[] frames)
        {
            m_Frames.AddRange(frames);
        }

        public AnimatedTexture(TextureRegion[] textures, uint frameDuration)
        {
        ...
        public AnimatedTexture Stop()
        {
            m_playing = false;
            return this;
        }

        public AnimatedTexture Restart()
        {
            m_playing = true;
            m_currentFrame = 0;
            return this;
