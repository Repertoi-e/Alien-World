...
public partial class GameEntity {
    ...
    public void AddSprite(Alien_World.Graphics.IRenderable2D newRenderable, bool newFlipped) {
    ...
    public void ReplaceSprite(Alien_World.Graphics.IRenderable2D newRenderable, bool newFlipped) {
        var index = GameComponentsLookup.Sprite;
        var component = CreateComponent<SpriteComponent>(index);
        component.Renderable = newRenderable;
        component.Flipped = newFlipped;
